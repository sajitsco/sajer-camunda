...
import com.sajits.sajer.plugin.executionlistener.SajerExecutionListener;
...
public class ProcessApplicationEventParseListener implements BpmnParseListener {
  ...
  public final static ExecutionListener EXECUTION_LISTENER = new SajerExecutionListener();
